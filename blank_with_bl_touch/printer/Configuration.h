...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-5/BigTreeTech E3 RRF"
...
#define STRING_CONFIG_H_AUTHOR "(HellBz, Ender-5)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -24, -2 }
